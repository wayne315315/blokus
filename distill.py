...
# ==========================================
def run_distillation(epochs=30, batch_size=8192):
    ...
    print("\n📚 Loading Teacher Model (4 Blocks, 16 Filters)...", flush=True)
    teacher_model = PyTorchAdvancedBlokusModel(num_blocks=4, filters=16).to(device)
    ...
    # --- 2. Initialize the Student Model (Large) ---
    STUDENT_BLOCKS = 8
    STUDENT_FILTERS = 64
